...
const PROJECT_IMAGES = [
  "https://storage.googleapis.com/msgsndr/Tx5eKisj3Xluq1SeZKe3/media/6986376e3fae0a3311363df8.png",
  "https://storage.googleapis.com/msgsndr/Tx5eKisj3Xluq1SeZKe3/media/6986376e9c68909629a5ac87.png",
  "https://storage.googleapis.com/msgsndr/Tx5eKisj3Xluq1SeZKe3/media/698638efaee74000f726dbbb.png"
];
    ...
    <div className="relative max-w-7xl mx-auto px-6 w-full z-10">
      <div className="max-w-3xl">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-[1] text-white uppercase tracking-tighter [text-shadow:_0_4px_12px_rgb(0_0_0_/_90%)]">
          COMPLETE <span className="text-[#FF4D00]">BIOHAZARD CLEANUP</span> & RESTORATION
        </h1>
        <p className="text-lg md:text-2xl text-white mt-6 leading-relaxed font-bold max-w-2xl [text-shadow:_0_2px_8_px_rgb(0_0_0_/_100%)]">
          Expert biohazard cleanup, decontamination, and sanitation services for environments impacted by hazardous biological materials.
        </p>
        <div className="pt-8">
          <a 
            href="tel:8339122610" 
    ...
    <div className="max-w-7xl mx-auto px-6">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16">
          {[
            { icon: <Award size={26} />, text: "IICRC CERTIFIED BIOHAZARD CLEANUP" },
            { icon: <Building2 size={26} />, text: "RESIDENTIAL & COMMERCIAL BIOHAZARD SERVICES" },
    ...
    <div className="max-w-7xl mx-auto px-6">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-500 max-w-2xl mx-auto font-semibold uppercase tracking-tight mb-8">
          ONE SOLUTION FOR EVERY TYPE OF BIOHAZARD EXPOSURE
        </p>
        <div className="max-w-4xl mx-auto">
          <p className="text-lg md:text-xl text-black font-medium leading-relaxed">
            Biohazard situations require immediate, professional action to reduce health risks and prevent further contamination. We provide comprehensive biohazard cleanup services for residential and commercial properties, specializing in the removal of contaminated materials, thorough sanitation, and controlled disposal procedures. Our experienced team manages the entire process, including safety protocols and insurance documentation, so you can focus on returning your property to a safe and functional state.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {[
          { icon: <Flame />, title: "BIOHAZARD DECONTAMINATION", desc: "Surface and material decontamination." },
          { icon: <Clock />, title: "24/7 BIOHAZARD RESPONSE", desc: "Immediate containment and mitigation." },
          { icon: <Wrench />, title: "SAFE MATERIAL REMOVAL", desc: "Removal of contaminated structural components." },
          { icon: <Home />, title: "SANITATION & DISINFECTION", desc: "Complete cleaning and pathogen neutralization." },
          { icon: <Building2 />, title: "COMMERCIAL BIOHAZARD", desc: "Industrial and facility biohazard cleanup." }
        ].map((service, idx) => (
    ...
    <section className="py-20 bg-black text-white">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-12 opacity-90">
          PROFESSIONAL BIOHAZARD CLEANUP PROJECTS
        </h2>
        ...
        {[
          {
            ...
            desc: "Call us 24/7 and our trained biohazard response team is dispatched quickly to contain hazards and protect the affected environment."
          },
          {
            title: "EXPERT BIOHAZARD ASSESSMENT",
            desc: "We conduct a detailed evaluation of contamination levels, affected materials, and exposure risks to create a precise cleanup plan."
          },
          {
            title: "FULL SANITATION & RESTORATION",
            desc: "Our team performs complete biohazard cleanup, sanitation, and restoration to return your property to a safe, usable condition."
          }
        ].map((item, idx) => (
      ...
      <div className="flex flex-col lg:flex-row items-start gap-20 text-white">
        <div className="lg:w-1/2">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter leading-none mb-8">
            BIOHAZARD INSURANCE DOCUMENTATION EXPERTISE
          </h2>
          <p className="text-xl text-white/80 font-bold leading-relaxed">
            Biohazard cleanup claims require accurate documentation and strict compliance with insurance and regulatory standards. We simplify the claims process by providing clear evidence, detailed reporting, and industry-standard estimates, ensuring your coverage is applied correctly and without unnecessary delays.
          </p>
        </div>
        
        <div className="lg:w-1/2 w-full space-y-8">
          {[
            { icon: <Layers size={24} />, title: "XACTIMATE BIOHAZARD ESTIMATES", desc: "Precise, insurance-approved pricing for biohazard cleanup and restoration services." },
            { icon: <Camera size={24} />, title: "CONTAMINATION INVENTORY LOGGING", desc: "Detailed documentation of affected materials, contents, and contaminated zones." },
            { icon: <FileSearch size={24} />, title: "DETAILED CONTAMINATION REPORTS", desc: "Clear reporting of sanitation procedures, contamination levels, and cleanup verification." }
          ].map((feature, idx) => (
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-10">
          ...
          <div className="space-y-4">
            <h2 className="text-3xl md:text-4xl font-black text-black uppercase tracking-tighter">IMMEDIATE BIOHAZARD HELP</h2>
            ...
            <p className="text-xl text-gray-500 font-medium max-w-md leading-relaxed">
              Serving our community with 24/7 priority biohazard cleanup and sanitation services.
            </p>
          </div>
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="space-y-2">
                ...
                <select className="w-full bg-white/5 border border-white/10 rounded-xl px-6 py-4 text-white font-bold focus:outline-none focus:border-[#FF4D00] transition-all appearance-none cursor-pointer">
                  <option className="bg-[#002D72] text-white">Select a biohazard service…</option>
                  <option className="bg-[#002D72] text-white">Biohazard Decontamination</option>
                  <option className="bg-[#002D72] text-white">Sanitation & Disinfection</option>
                  <option className="bg-[#002D72] text-white">Material Removal</option>
